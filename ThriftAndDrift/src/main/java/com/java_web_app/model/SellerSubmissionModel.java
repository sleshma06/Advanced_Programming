...
public class SellerSubmissionModel {
    private int id;
    private int userId;
    ...
    public String getDropoffTimeSlot() {
        return dropoffTimeSlot;
    }

    public void setDropoffTimeSlot(String dropoffTimeSlot) {
        this.dropoffTimeSlot = dropoffTimeSlot;
    }
